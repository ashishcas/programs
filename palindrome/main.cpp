...
void Part(vector<vector<string> >&allPart, vector<string> &currPart,
                   int start, int n, string str)
{
    ...
    for (int i=start; i<n; i++)
    {
        ...
        if (check(str, start, i))
        {
            ...
            Part(allPart, currPart, i+1, n, str);
